...
album3.albumDetails.labels = "Sire"
...
let n = talkingHeadsAlbums.length
if(n % 2 === 0){
  console.log(`The number ${n} is divisible by 2`)
}else if(n % 3 === 0){
  console.log(`The number ${n} is divisible by 3`)
} else {
...
for(let albumNames of talkingHeadsAlbums) {
  console.log(albumNames.title)
}
